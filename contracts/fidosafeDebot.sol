...
contract FidosafeDebot is Debot {
    ...
    function deploySucceed() public {
        Terminal.print(0, format("Your contract is ready!\n\nPlease navigate to https://app.fidosafe.com/#/{}/transactions (clickable)", fidoSafeAddress));
    }
    ...
    function addUser(address fsAddress, uint32 trId, uint256 uPubkey) public {
        ...
        Terminal.print(0, format("See the result at: https://app.fidosafe.com/#/{}/transactions (clickable)", fsAddress));
