<template>
    <b-overlay :show="confirmations.length === 0">
        ...
        <b-row class="mb-2 transaction-border pt-2" v-for="confirmation in confirmations" :key="confirmation.created">
            <b-col sm="4"><span>User </span>{{ confirmation.user.pubkey | short }}</b-col>
            ...
            <b-col sm="2" class="pubkey-wrap mb-3"><small class="text-muted">{{ confirmation.created | formatDate }}</small></b-col>
        </b-row>
    </b-overlay>
</template>
